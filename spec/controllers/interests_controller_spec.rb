  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved interest as @interest" do
        ...
        post :create, {:interest => { "user_id" => "invalid value" }}, valid_session
        assigns(:interest).should be_a_new(Interest)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested interest" do
        ...
        Interest.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => interest.to_param, :interest => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the interest as @interest" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Interest.any_instance.stub(:save).and_return(false)
        put :update, {:id => interest.to_param, :interest => { "user_id" => "invalid value" }}, valid_session
        assigns(:interest).should eq(interest)
      end
